...
class FichaIndividualCreate extends Component
{
    ...
    {
        if ((int) $this->tipoTitular !== 2) {
            return;
        }

        $ruc = trim((string) $this->numedoc3);
        ...
        if (empty($urlruc)) {
            ...
            session()->flash(
                'warning',
                'La URL de consulta de RUC no está configurada.'
            );
        ...
        try {
            ...
            if (
                ...
                session()->flash(
                    'warning',
                    $persona['error'] ?? 'No se encontraron datos para el RUC ingresado.'
                );
            ...
            session()->flash(
                'warning',
                'Ocurrió un error al consultar el RUC.'
            );
        }
    }
            ...
            if ($this->esta_llenado == "4") {
                ...
                if ($this->condtitular != "05") {
                    $this->validate([
                        ...
                        'codigoviaotros'                => 'nullable|max:15',
                        'tipoviaotros'                  => 'nullable|max:15',
                        'nombreviaotros'                => 'nullable|max:100',
                        'nmunicipalotros'               => 'nullable|max:15',
                        'ninteriorotros'                => 'nullable|max:15',
                        'codigohurbanootros'            => 'nullable|max:15',
